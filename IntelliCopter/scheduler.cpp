...
void System::createTasks() {
        ...
        portBASE_TYPE pPubAttitude = xTaskCreate(publish.attitude, NULL, configMINIMAL_STACK_SIZE + 1024, NULL, 1, NULL);
        ...
        portBASE_TYPE pComTransferMsgToGcs = xTaskCreate(communicate.transferMsgToGcs, NULL, configMINIMAL_STACK_SIZE + 800, NULL, 1, NULL);
        Serial.println("\t\t\tSuccess.");
    #endif
