...
Vector comp::readNormalize(void)
{
...
void comp::setOffset(int xo, int yo)
{
    xOffset = xo;
    yOffset = yo;
}

void comp::setRange(hmc5883l_range_t range)
{
    switch(range)
    {
...
hmc5883l_range_t comp::getRange(void)
{
    return (hmc5883l_range_t)((readRegister8(HMC5883L_REG_CONFIG_B) >> 5));
}

void comp::setMeasurementMode(hmc5883l_mode_t mode)
{
    uint8_t value;
...
hmc5883l_mode_t comp::getMeasurementMode(void)
{
    uint8_t value;
...
void comp::setDataRate(hmc5883l_dataRate_t dataRate)
{
    uint8_t value;
...
hmc5883l_dataRate_t comp::getDataRate(void)
{
    uint8_t value;
...
void comp::setSamples(hmc5883l_samples_t samples)
{
    uint8_t value;
...
hmc5883l_samples_t comp::getSamples(void)
{
    uint8_t value;
...
void comp::writeRegister8(uint8_t reg, uint8_t value)
{
...
uint8_t comp::fastRegister8(uint8_t reg)
{
    uint8_t value;
    Wire.beginTransmission(HMC5883L_ADDRESS);
    #if ARDUINO >= 100
...
uint8_t comp::readRegister8(uint8_t reg)
{
    uint8_t value;
    Wire.beginTransmission(HMC5883L_ADDRESS);
    #if ARDUINO >= 100
...
int16_t comp::readRegister16(uint8_t reg)
{
    int16_t value;
    Wire.beginTransmission(HMC5883L_ADDRESS);
    #if ARDUINO >= 100
