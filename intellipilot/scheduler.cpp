...
void scheduler::taskCreate() {
    ...
    Serial.print("\t\tgetEulerAnglesGyroThread..."); sa1 = xTaskCreate(_tasks.getEulerAnglesGyroThread, NULL, configMINIMAL_STACK_SIZE + 300, NULL, 1, NULL); Serial.println("\t\tSuccess.");
    Serial.print("\t\tgetAccAltThread...");          sa2 = xTaskCreate(_tasks.getAccAltThread, NULL, configMINIMAL_STACK_SIZE + 200, NULL, 1, NULL);			Serial.println("\t\t\tSuccess.");
    ...
    Serial.print("\t\tgetPosThread...");             sa5 = xTaskCreate(_tasks.getPosThread, NULL, configMINIMAL_STACK_SIZE + 300, NULL, 1, NULL);             Serial.println("\t\t\t\tSuccess.");
